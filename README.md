...
- `git clone https://github.com/UniversalPropositions/UP_Hindi-HDTB.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Hindi-HDTB>/ --input_up=<up_path_to_UP_Hindi-HDTB>/ --output=<path_to_UD+UP_Hindi-HDTB>/`
